...
# Convert to dB Scale
# 
# - 由于现在我处理的ctrl的spectrogram的freqs pts和36-MEG data 一样，所以你可以用SGM_net_large来simulate PSD。
...
if len(stat_part) > 0:
    folder_name = f"LSTM1_simu_net_ctrlwavelet_{paras_rnn.loss_name}_{stat_part}"; #!!!!
else:
    folder_name = f"LSTM1_simu_net_ctrlwavelet_{paras_rnn.loss_name}";
